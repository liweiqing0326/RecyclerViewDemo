...
public class LinearLayoutDemo2Activity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linear_layout_demo2);
        ...
        demoSwiperefreshlayout.setOnRefreshListener(this);
        // 设置下拉进度的背景颜色，默认就是白色的
